...
ax[0].plot(history.history['accuracy'],'r',linewidth=2.0, label='Training Accuracy')
ax[0].plot(history.history['val_accuracy'],'b',linewidth=2.0, label='Testing Accuracy')
